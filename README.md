...
To train recovery from the edge of road, two strategies were applied. First, left and right camera images were included which can train car to keep driving toward the center of the road. Also, by intentionally driving from out of the road to the center, data for recovery was included.
